    ...
    <div className="bg-white text-brand-dark min-h-screen">
      ...
      <section className="relative py-24 bg-brand-darker text-white overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <span className="inline-flex items-center gap-2 px-4 py-2 text-brand-accent text-xs font-semibold uppercase tracking-wider bg-white/5 border border-brand-accent/20 backdrop-blur-sm">
      ...
      {/* Services Stack */}
      <section className="mx-auto max-w-6xl px-0 sm:px-6 lg:px-8 py-0 sm:py-20">
        ...
        {/* CTA */}
        <div className="bg-brand-darker py-16 text-center">
          <motion.div
            initial={{ opacity: 0, y: 16 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.5 }}
            className="mx-auto max-w-2xl px-4 space-y-4"
          >
            <h3 className="font-display text-2xl font-bold text-white">Ready to get started?</h3>
            <p className="text-sm text-gray-400 max-w-md mx-auto">
              Request a quote today and our team will get back to you within 24 business hours.
            </p>
            <button
              onClick={() => onRequestQuoteWithService('')}
              className="inline-flex items-center gap-2 bg-brand-accent hover:bg-brand-accent-hover text-white px-6 py-3.5 text-sm font-bold transition-all hover:shadow-lg active:scale-[0.98]"
            >
              Request a Quote
              <ArrowRight className="h-4 w-4" />
            </button>
